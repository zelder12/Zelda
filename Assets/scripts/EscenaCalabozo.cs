...
public class EscenaCalabozo : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            SceneManager.LoadScene("Zelda 2", LoadSceneMode.Single);
    ...
    {
        if (scene.name == "Zelda 2")
        {
            GameObject player = GameObject.FindGameObjectWithTag("Player");
            if (player != null)
            {
                player.transform.position = new Vector3(46.42f, -15.72f, -0.007f);
